...
def enrich_event(event_id, handle):
    ...
    response = get_api_response("https://graph.facebook.com/v2.8/1553622081610922?access_token=587748278082312|9MlBC5HE-N5bfBXLfMHi09_AAPg&fields=attending_count,can_guests_invite,category,declined_count,end_time,guest_list_enabled,interested_count,is_canceled,is_page_owned,is_viewer_admin,maybe_count,name,noreply_count,place,start_time,timezone,type,updated_time&debug=all&format=json&method=get&pretty=0&suppress_http_code=1")
...
response = get_api_response("https://graph.facebook.com/v2.8/289551394710535?access_token=587748278082312|9MlBC5HE-N5bfBXLfMHi09_AAPg&fields=attending_count,can_guests_invite,category,declined_count,end_time,guest_list_enabled,interested_count,is_canceled,is_page_owned,is_viewer_admin,maybe_count,name,noreply_count,place,start_time,timezone,type,updated_time&debug=all&format=json&method=get&pretty=0&suppress_http_code=1")
print(response)
print(response.get('id'))

print("=======================================================================")
print("=======================================================================")
# handle_list = get_handles_from_csv("/home/nkishore/facebook_crawler/facebook_pages.csv")
